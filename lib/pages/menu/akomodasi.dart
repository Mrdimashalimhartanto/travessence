...
class Akomodasi extends StatefulWidget {
  const Akomodasi({super.key});

  @override
  State<Akomodasi> createState() => _AkomodasiState();
}

class _AkomodasiState extends State<Akomodasi> {
